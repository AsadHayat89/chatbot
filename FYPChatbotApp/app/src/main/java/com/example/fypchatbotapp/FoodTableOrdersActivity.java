...
public class FoodTableOrdersActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_food_table_orders);
        ...
        toolbar.setTitle("Table Order Price Details");
        ...
        toolbar.setNavigationOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (user.equals("user"))
                {
                    backIntent = new Intent(getApplicationContext(), TableBookingOrders.class);
                }
                else
                {
                    backIntent = new Intent(getApplicationContext(), AdminTableBookingOrders.class);
                }
        ...
        tvTotalPrice = findViewById(R.id.table_order_total_price);
        ...
        orders.child(orderId).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                tvTotalPrice.setText("Total Price : Rs. "+o.getTotal_price());

...
public class AdminTableOrderViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
    public TextView txtOrderPhone, txtOrderDate, txtOrderTime, txtOrderName, txtOrderPeople;
    public AppCompatButton btnDeltableOrder;
    private ItemClickListener itemClickListener;

    public AdminTableOrderViewHolder(@NonNull View itemView) {
        super(itemView);
        ...
        btnDeltableOrder = itemView.findViewById(R.id.DelTableOrder);
